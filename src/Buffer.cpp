    ...
    QPlainTextEdit(parent)
{
  ...
  connect(this, SIGNAL(blockCountChanged(int)), this, SLOT(updateLinumWidth(int)));
  connect(this, SIGNAL(updateRequest(QRect,int)), this, SLOT(updateLinumArea(QRect, int)));
...
Buffer::resizeEvent(QResizeEvent *e)
{
  ...
  linum_area->setGeometry(QRect(cr.left(), cr.top(), linumWidth(), cr.height()));
}
